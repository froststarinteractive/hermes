...
export default defineConfig({
  ...
  head: [
    [
      ...
      {
        rel: "icon",
        href: "https://raw.githubusercontent.com/froststarinteractive/hermes/e1545925d4dae0f904fb02a1c28516131f448fb6/assets/favicon-simplified.svg",
      },
    ],
  ],
  ...
  themeConfig: {
    ...
    socialLinks: [
      {
        icon: "github",
        link: "https://github.com/froststarinteractive/hermes",
      },
